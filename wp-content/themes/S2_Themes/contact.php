...
<html>
    ...
    <div class="blurDiv"></div>
        ...
        <section class="talk">
            ...
            <a href="mailto:contact@seg2inov.com">
                <div class="big whiteButton">
                    <p>contact@seg2inov.fr</p>
                    <div class="partClique">
                        <p>Envoyer un mail</p>
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\right.svg" alt="clique mail">
                    </div>
                </div>
            </a>
        ...
        <section class="reseau">
            ...
            <a href="https://www.linkedin.com/company/seg2inov/?viewAsMember=true">
