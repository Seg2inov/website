...
<img class="afnor"src="<?php echo get_stylesheet_directory_uri(); ?>\assets\logo\afnor.PNG" alt="AFNOR">
    <div class="part1">
        ...
        <p class="descriptifAfnor"><span class="orange bold">SEG2 INOV</span>  est inscrit dans un processus de certification <span class="bold">NF525</span> et <span class="bold">NF203</span> pour le logiciel <span class="orange bold">S2CASH</span>. <br> Certification enregistrée sous le numéro : FR 37 978 843 951 <br> Vous pouvez vérifier à tout instant la validité de cette preuve d’engagement en scanneant le QR-code ci-joint.</p>
    ...
    <div class="contenantDetails">
        <details  >
            <summary>
                ...
                <p>Une vision de l’entreprise</p>
            </summary>
            <div class="contenaireArrowText"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element margintop" >  Analyse générale CA BRUT et NET des paniers moyens, des  annulations, des retours  </p>
            </div>
            <div class="contenaireArrowText"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
        ...
        <details>
            <summary>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\small.svg" alt="clique">
                <p>Une caisse qui s’adapte à vous </p>
            </summary>
        ...
        <details>
            <summary>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\small.svg" alt="clique"> 
                <p> Une gestion de la chaine d’approvisionnement </p>
            </summary>
            <div class="contenaireArrowText"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
        ...
        <details>
            ...
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Règlements
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Rayons
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Familles
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Types de commandes
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >TVA
            ...
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Modifs de remise
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Vendeurs
                </p>
            </div>
            <div class="contenaireArrowText li"><img class="flecheDetails" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow/orange.svg" alt="fleche">
                <p class="element " >Badges
                </p>
            </div>
...
<section class="descriptionCommerce">
    <div class="columnInformation fonction">
        ...
        <img class="commerceillustration one" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\img\complete.webp" alt="illustration">
    </div>
    ...
    <div class="columnInformation everywhere">
        <img class="commerceillustration one" src="<?php echo get_stylesheet_directory_uri(); ?>\assets\img\partout.webp" alt="illustration">
        <div class="">
            <h3>Partout</h3>
...
<!-- ____________________________________________Evenement__________________________________________________________________________ -->
 <section class="evenement">
    <div class="title">
        <h2>
           Retrouvez nous à des évènement
     ...
     <div class="contenaireFooter">
         ...
         <div class="">
            ...
            <div class="">
                ...
                <a target="_blank" class="linkFooter" href="https://www.linkedin.com/company/seg2inov/?viewAsMember=true"><p>Linkedin</p><img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\toprightlight.svg" alt="clique"></a>
                <a target="_blank" class="linkFooter" href="https://www.instagram.com/seg2inov/"><p>Instagram</p><img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\toprightlight.svg" alt="clique"></a>
                <a target="_blank" class="linkFooter" href="https://www.facebook.com/people/Seg2inov/61562257696981/"><p>Facebook</p><img src="<?php echo get_stylesheet_directory_uri(); ?>\assets\arrow\toprightlight.svg" alt="clique"></a> 
            </div>
        </div>
