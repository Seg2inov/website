...
<section class="description">
    ...
    <div class="scrollzone">
        ...
        <div class="contentElement">
            ...
            <div class="">
                <h3>Un logiciel d’analyse </h3>
                <p>Remontées des analyses de caisse</p>
                <!-- Voir plus de détails -->
            </div>
            <div class="">
...
<section class="descriptionCommerceDetails">
    ...
    <div class="contenantDetails">
        <details>
            <summary><p>Client</p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
           <p class="margintop">Création et gestion des fiches clients</p>
           <p>Système de fidélité</p>
        </details>
        <details>
            <summary><p>Fournisseur </p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
           <p class="margintop">Gestion des commandes et des achats</p>
        </details>
        <details>
            <summary> <p>Produit </p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
           <p class="margintop">Gestion et  classification des produits par rayon, par famille </p>
           <p>Création d’étiquettes</p>
        </details>
        <details>
            <summary> <p>Stocks </p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
           <p class="margintop">Réalisation d’inventaire</p>
           <p>Gestion des mouvements</p>
        </details>
        <details>
            <summary> <p> Analyse </p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
        ...
        <details>
            <summary><p> Commercial </p><img src="wp-content\themes\S2_Themes\assets\arrow\small.svg" alt="clique"></summary>
